...
namespace ZGmarket.Controllers
{
    ...
    public class SupplyController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            SupplyView supplyIndex = new SupplyView() { };
            return View(supplyIndex);
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            SupplyView supplyCreate = new SupplyView()
            {
        ...
        // POST: Supply/Create
        [HttpPost]
        public async Task<IActionResult> Create(SupplyView newSupply)
        {
            //Добавить товары на склад на основе поставки
            try
            {
                await _supplyRepo.AddSupply(newSupply.Supply);
